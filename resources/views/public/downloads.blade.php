...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-10 text-center md:text-left">
        <h1 class="text-3xl font-extrabold text-brand-dark sm:text-4xl">
            Aset & Starter Kit
        </h1>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-300 flex flex-col h-full">
            <div class="p-6 flex-grow">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-12 h-12 bg-green-50 rounded-lg flex items-center justify-center text-brand-light">
                        <!-- File Icon -->
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2 truncate" title="{{ $asset->file_name }}">
                    {{ $asset->file_name }}
                </h3>
    ...
    <div class="text-center py-12 bg-white rounded-lg border border-gray-200">
        ...
        <p class="mt-1 text-sm text-gray-500">Belum ada file yang dipublikasikan oleh administrator.</p>
    </div>
    @endif
</div>
@endsection
