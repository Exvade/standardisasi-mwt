...
<div class="mb-8 flex justify-between items-end">
    <div>
        <h1 class="text-3xl font-heading font-extrabold text-gray-900 tracking-tight">Daftar Kategori</h1>
        <p class="text-gray-500 mt-1">Kelola kategori untuk komponen UI Anda.</p>
    </div>
    <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-4 py-2 bg-brand-dark hover:bg-green-800 text-white text-sm font-medium rounded-lg shadow-sm transition-colors">
        ...
        <table class="min-w-full divide-y divide-gray-100">
            ...
            <tbody class="bg-white divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-md bg-gray-100 text-gray-600 font-mono">
                            {{ $category->slug }}
                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('admin.categories.edit', $category) }}" class="p-2 text-brand-light hover:bg-green-50 rounded-lg transition-colors tooltip" title="Edit">
