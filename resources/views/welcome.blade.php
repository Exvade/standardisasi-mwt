    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative z-10 py-16 md:py-24 lg:py-32 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <h1 class="text-4xl font-heading font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl leading-tight tracking-tight">
                    <span class="block">Membangun Sistem</span>
                    <span class="block text-transparent bg-clip-text bg-gradient-to-r from-brand-dark dark:from-brand-light to-brand-light dark:to-green-300 pb-2">Lebih Cepat & Seragam</span>
                </h1>
                <p class="mt-4 max-w-md mx-auto lg:mx-0 text-base text-gray-600 dark:text-gray-300 sm:text-lg md:mt-6 md:text-xl md:max-w-3xl font-light">
                    Pusat referensi <em class="font-medium italic text-gray-800 dark:text-gray-200">Single Source of Truth</em> untuk para pengembang PT Mada Wikri Tunggal. Dapatkan panduan lengkap, aturan basis data, dan komponen UI siap pakai.
                </p>
...
<div class="py-24 bg-brand-surface dark:bg-gray-900 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 dark:text-white">Mengapa Kita Butuh Standardisasi?</h3>
            <p class="mt-4 text-gray-600 dark:text-gray-400 text-lg">Meninggalkan kebiasaan <em class="font-medium italic">spaghetti code</em> dan antarmuka yang tidak konsisten antar proyek.</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <!-- Feature 1 -->
            <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300 relative overflow-hidden group">
                <div class="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 rounded-full bg-green-50 dark:bg-green-900/20 transition-transform group-hover:scale-150 duration-500 ease-in-out"></div>
                <div class="relative z-10">
                    <div class="w-14 h-14 bg-green-100 dark:bg-green-900/40 rounded-xl flex items-center justify-center text-brand-dark dark:text-brand-light mb-6">
                    ...
                    <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-3 font-heading">Development Cepat</h4>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Tidak perlu lagi memikirkan komponen UI dari nol. Semua tombol, <span class="italic font-medium">form</span>, dan tabel sudah tersedia. Tinggal panggil dan gunakan.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Aturan baku terkait <span class="italic font-medium">Error Handling</span> dan <span class="italic font-medium">API Responses</span> membuat aplikasi terhindar dari <span class="italic font-medium">crash</span> tak terduga yang membingungkan <span class="italic font-medium">user</span>.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        Developer baru tidak perlu menebak-nebak struktur folder atau cara merancang <span class="italic font-medium">database</span>. Semuanya tertulis rapi di satu portal.
                    </p>
                </div>
            </div>
        </div>
...
<div class="py-24 bg-brand-surface dark:bg-gray-900 relative border-t border-gray-100 dark:border-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h3 class="text-3xl md:text-4xl font-heading font-bold text-gray-900 dark:text-white">Cara Memulai Proyek Baru</h3>
            <p class="mt-4 text-gray-600 dark:text-gray-400 text-lg">Hanya butuh 3 langkah sederhana untuk menjalankan aplikasi standar MWT di mesin lokal Anda.</p>
        </div>
        ...
        <div class="relative max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div class="relative flex flex-col items-center text-center">
                    <div class="w-24 h-24 bg-white dark:bg-gray-800 rounded-full border-4 border-green-100 dark:border-green-900 shadow-lg flex items-center justify-center relative z-10 mb-6">
                        <span class="text-3xl font-heading font-extrabold text-brand-dark dark:text-brand-light">1</span>
                    </div>
                    <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-2 font-heading">Clone Starter Repo</h4>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Unduh repositori kerangka dasar yang sudah dilengkapi dengan Tailwind V4 dan konfigurasi standar.</p>
                ...
                <div class="relative flex flex-col items-center text-center">
                    <div class="w-24 h-24 bg-white dark:bg-gray-800 rounded-full border-4 border-green-100 dark:border-green-900 shadow-lg flex items-center justify-center relative z-10 mb-6">
                        <span class="text-3xl font-heading font-extrabold text-brand-dark dark:text-brand-light">2</span>
                    </div>
                    <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-2 font-heading">Install Dependencies</h4>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Masuk ke dalam folder proyek dan pasang seluruh paket PHP maupun Node.js yang dibutuhkan.</p>
                    <div class="bg-gray-900 rounded-lg p-3 text-left w-full shadow-md">
                ...
                <div class="relative flex flex-col items-center text-center">
                    <div class="w-24 h-24 bg-white dark:bg-gray-800 rounded-full border-4 border-green-100 dark:border-green-900 shadow-lg flex items-center justify-center relative z-10 mb-6">
                        <span class="text-3xl font-heading font-extrabold text-brand-dark dark:text-brand-light">3</span>
                    </div>
                    <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-2 font-heading">Siapkan Environment</h4>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Salin file .env, <span class="italic font-medium">generate application key</span>, dan jalankan server pengembangan lokal.</p>
                    <div class="bg-gray-900 rounded-lg p-3 text-left w-full shadow-md">
